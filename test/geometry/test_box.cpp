...
TEST(test_box, point_to_box_position){
	...
	ASSERT_EQ(IsInOn(b, Point2( 1.0, 1.0)), true);
}

TEST(test_box, box_box_in_on){
...
inline void BoxLinePositiveCase(int num_case,
        double x, double y,
...
TEST(test_box, box_vs_line_positive){
    int n = 100;
