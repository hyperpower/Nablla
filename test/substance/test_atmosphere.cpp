...
TEST(atmosphere, test1) {
	...
	gnu.add(GnuplotActor::XY(
			      x, y,
			  	  "using 1:2 title \"\" ",
		          "with lines lw 2"));
	gnu.set_terminal_png(OUTPUTPATH + "Fig3MolecularScaleTemperature", 600, 800);
	gnu.plot();
}
...
//	gnu.set_xrange(160, 300);
	...
	gnu.add(GnuplotActor::XY(
			      x, y,
			  	  "using 1:2 title \"\" ",
		          "with lines lw 2"));
	gnu.set_terminal_png(OUTPUTPATH + "Fig6MolecularWeight", 600, 800);
	gnu.plot();
}
...
//	gnu.set_xrange(160, 300);
	...
	gnu.add(GnuplotActor::XY(
			      x, y,
			  	  "using 1:2 title \"\" ",
		          "with lines lw 2"));
	gnu.set_terminal_png(OUTPUTPATH + "Fig7Pressure", 600, 900);
	gnu.plot();
}
...
//	gnu.set_xrange(160, 300);
	...
	gnu.add(GnuplotActor::XY(
			      x, y,
			  	  "using 1:2 title \"\" ",
		          "with lines lw 2"));
	gnu.set_terminal_png(OUTPUTPATH + "Fig7Density", 700, 900);
	gnu.plot();
}
...
//	gnu.set_xlogscale();
	...
	gnu.add(GnuplotActor::XY(
			      x, y,
			  	  "using 1:2 title \"\" ",
		          "with lines lw 2"));
	gnu.set_terminal_png(OUTPUTPATH + "Fig13SpeedOfSound", 700, 900);
	gnu.plot();
}
...
//	gnu.set_xlogscale();
	...
	gnu.add(GnuplotActor::XY(
			      x, y,
			  	  "using 1:2 title \"\" ",
		          "with lines lw 2"));
	gnu.set_terminal_png(OUTPUTPATH + "Fig14DynamciViscosity", 700, 900);
	gnu.plot();
}
